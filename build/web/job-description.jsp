                    ...
                    <div class="col-md-6" style="background-color: #f9f8f9; margin-top: 10px">
                        ...
                        <jsp:scriptlet>
                            String id = "",job_profile = "", company = "", experience = "", description = "", date1 = "", time1 = "",
                                    salary = "", no_of_openings = "", job_location = "", time_venue = "", 
                                    c_person_profile = "",c_phone_no= "",c_person_name= "";
                            try {
                                ...
                                if (rs.next()) {
                                    ...
                                    company_email= rs.getString("c_email");      
                                    ...
                                    PreparedStatement ps2 = con.prepareStatement("select * from company_reg where c_email=?");
                                    ps2.setString(1,company_email);
                                    ResultSet rs2 = ps2.executeQuery();
                                    if (rs2.next()) {
                                        c_phone_no=rs2.getString("c_mobile_no");
                                        c_person_name=rs2.getString("contact_person");
                                    }
